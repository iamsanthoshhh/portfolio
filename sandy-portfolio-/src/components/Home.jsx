		...
		<div className='area relative z-0 bg-black w-screen h-screen'>
			...
			<div className='hero relative h-[calc(100vh)] flex justify-center items-center text-white' id='hero'>
				<div className='pt-4 h-36 backdrop-blur-sm rounded-3xl'>
					...
					<p className='mt-3 text-xl'>I love to learn and build scalable and optimized backend systems also to build  Machine Learning model solutions for the problem statements.</p>
				</div>      
			</div>
			<Footer/>
		</div>	
